...
public class Mat4 {
	...
	A[0][0] = ( -(M.A[1][3]*M.A[2][2] - M.A[1][2]*M.A[2][3])*M.A[3][1] + (M.A[1][3]*M.A[2][1] - M.A[1][1]*M.A[2][3])*M.A[3][2] - (M.A[1][2]*M.A[2][1] - M.A[1][1]*M.A[2][2])*M.A[3][3] ) / D;
	A[0][1] = (  (M.A[0][3]*M.A[2][2] - M.A[0][2]*M.A[2][3])*M.A[3][1] - (M.A[0][3]*M.A[2][1] - M.A[0][1]*M.A[2][3])*M.A[3][2] + (M.A[0][2]*M.A[2][1] - M.A[0][1]*M.A[2][2])*M.A[3][3] ) / D;
	A[0][2] = ( -(M.A[0][3]*M.A[1][2] - M.A[0][2]*M.A[1][3])*M.A[3][1] + (M.A[0][3]*M.A[1][1] - M.A[0][1]*M.A[1][3])*M.A[3][2] - (M.A[0][2]*M.A[1][1] - M.A[0][1]*M.A[1][2])*M.A[3][3] ) / D;
	A[0][3] = (  (M.A[0][3]*M.A[1][2] - M.A[0][2]*M.A[1][3])*M.A[2][1] - (M.A[0][3]*M.A[1][1] - M.A[0][1]*M.A[1][3])*M.A[2][2] + (M.A[0][2]*M.A[1][1] - M.A[0][1]*M.A[1][2])*M.A[2][3] ) / D;

	A[1][0] = (  (M.A[1][3]*M.A[2][2] - M.A[1][2]*M.A[2][3])*M.A[3][0] - (M.A[1][3]*M.A[2][0] - M.A[1][0]*M.A[2][3])*M.A[3][2] + (M.A[1][2]*M.A[2][0] - M.A[1][0]*M.A[2][2])*M.A[3][3] ) / D;
	A[1][1] = ( -(M.A[0][3]*M.A[2][2] - M.A[0][2]*M.A[2][3])*M.A[3][0] + (M.A[0][3]*M.A[2][0] - M.A[0][0]*M.A[2][3])*M.A[3][2] - (M.A[0][2]*M.A[2][0] - M.A[0][0]*M.A[2][2])*M.A[3][3] ) / D;
	A[1][2] = (  (M.A[0][3]*M.A[1][2] - M.A[0][2]*M.A[1][3])*M.A[3][0] - (M.A[0][3]*M.A[1][0] - M.A[0][0]*M.A[1][3])*M.A[3][2] + (M.A[0][2]*M.A[1][0] - M.A[0][0]*M.A[1][2])*M.A[3][3] ) / D;
	A[1][3] = ( -(M.A[0][3]*M.A[1][2] - M.A[0][2]*M.A[1][3])*M.A[2][0] + (M.A[0][3]*M.A[1][0] - M.A[0][0]*M.A[1][3])*M.A[2][2] - (M.A[0][2]*M.A[1][0] - M.A[0][0]*M.A[1][2])*M.A[2][3] ) / D;

	A[2][0] = ( -(M.A[1][3]*M.A[2][1] - M.A[1][1]*M.A[2][3])*M.A[3][0] + (M.A[1][3]*M.A[2][0] - M.A[1][0]*M.A[2][3])*M.A[3][1] - (M.A[1][1]*M.A[2][0] - M.A[1][0]*M.A[2][1])*M.A[3][3] ) / D;
	A[2][1] = (  (M.A[0][3]*M.A[2][1] - M.A[0][1]*M.A[2][3])*M.A[3][0] - (M.A[0][3]*M.A[2][0] - M.A[0][0]*M.A[2][3])*M.A[3][1] + (M.A[0][1]*M.A[2][0] - M.A[0][0]*M.A[2][1])*M.A[3][3] ) / D;
	A[2][2] = ( -(M.A[0][3]*M.A[1][1] - M.A[0][1]*M.A[1][3])*M.A[3][0] + (M.A[0][3]*M.A[1][0] - M.A[0][0]*M.A[1][3])*M.A[3][1] - (M.A[0][1]*M.A[1][0] - M.A[0][0]*M.A[1][1])*M.A[3][3] ) / D;
	A[2][3] = (  (M.A[0][3]*M.A[1][1] - M.A[0][1]*M.A[1][3])*M.A[2][0] - (M.A[0][3]*M.A[1][0] - M.A[0][0]*M.A[1][3])*M.A[2][1] + (M.A[0][1]*M.A[1][0] - M.A[0][0]*M.A[1][1])*M.A[2][3] ) / D;

	A[3][0] = (  (M.A[1][2]*M.A[2][1] - M.A[1][1]*M.A[2][2])*M.A[3][0] - (M.A[1][2]*M.A[2][0] - M.A[1][0]*M.A[2][2])*M.A[3][1] + (M.A[1][1]*M.A[2][0] - M.A[1][0]*M.A[2][1])*M.A[3][2] ) / D;
	A[3][1] = ( -(M.A[0][2]*M.A[2][1] - M.A[0][1]*M.A[2][2])*M.A[3][0] + (M.A[0][2]*M.A[2][0] - M.A[0][0]*M.A[2][2])*M.A[3][1] - (M.A[0][1]*M.A[2][0] - M.A[0][0]*M.A[2][1])*M.A[3][2] ) / D;
	A[3][2] = (  (M.A[0][2]*M.A[1][1] - M.A[0][1]*M.A[1][2])*M.A[3][0] - (M.A[0][2]*M.A[1][0] - M.A[0][0]*M.A[1][2])*M.A[3][1] + (M.A[0][1]*M.A[1][0] - M.A[0][0]*M.A[1][1])*M.A[3][2] ) / D;
	A[3][3] = ( -(M.A[0][2]*M.A[1][1] - M.A[0][1]*M.A[1][2])*M.A[2][0] + (M.A[0][2]*M.A[1][0] - M.A[0][0]*M.A[1][2])*M.A[2][1] - (M.A[0][1]*M.A[1][0] - M.A[0][0]*M.A[1][1])*M.A[2][2] ) / D;
