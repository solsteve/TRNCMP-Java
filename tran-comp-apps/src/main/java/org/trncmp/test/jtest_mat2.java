...
/**
 * @file jtest_mat2.java
 *  Provides Unit Test the Mat2 functions.
 *  <p>
 *
...
// =======================================================================================
public class jtest_mat2 extends octave_utest {
    // -----------------------------------------------------------------------------------
	...
	double[][] testA_44 = new double[2][2];
	double[][] testB_44 = new double[2][2];

	rand( testA_44, dd );
	copy( testA, testA_44 );

	Mat2 d = new Mat2( testA_44 );
