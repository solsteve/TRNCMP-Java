...
/**
 * @file jtest_vec2.java
 *  Provides Unit Test the Vec2 functions.
 *  <p>
 *
...
// =======================================================================================
public class jtest_vec2 extends octave_utest {
    // -----------------------------------------------------------------------------------
	...
	double[] testA = new double[2];
	double[] testB = new double[2];

	rand( testA, dd );

	Vec2 c = new Vec2( testA );
	...
	Vec2 d = new Vec2( t1, t2 );

	double dx = t1-d.x;
	double dy = t2-d.y;

	oprint( "k", (dx*dx + dy*dy) );
	...
	ocheck( "set", "norm( a - 3.14*ones(2,1) )" );
