...
/**
 * @file jtest_mat3.java
 *  Provides Unit Test the Mat3 functions.
 *  <p>
 *
...
// =======================================================================================
public class jtest_mat3 extends octave_utest {
    // -----------------------------------------------------------------------------------
	...
	double[] testA = new double[9];
	double[] testB = new double[9];

	rand( testA, dd );

	Mat3 c = new Mat3( testA );
	...
	double[][] testA_44 = new double[3][3];
	double[][] testB_44 = new double[3][3];

	rand( testA_44, dd );
	copy( testA, testA_44 );

	Mat3 d = new Mat3( testA_44 );
